...
This classification model has the base model is a MobileNetV2 model
"""
...
if __name__ == "__main__":
    # get a video source, this video can be captured directly from camere, or a video file
    ...
    # Classes, its value orders depend on the model
    '''
    # for dataset 6307
